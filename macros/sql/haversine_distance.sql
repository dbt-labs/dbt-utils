...
{% set radians_lat1 = cc_dbt_utils.degrees_to_radians(lat1) %}
{% set radians_lat2 = cc_dbt_utils.degrees_to_radians(lat2) %}
{% set radians_lon1 = cc_dbt_utils.degrees_to_radians(lon1) %}
{% set radians_lon2 = cc_dbt_utils.degrees_to_radians(lon2) %}
{%- if unit == 'mi' %}
    {% set conversion_rate = 1 %}
{% elif unit == 'km' %}
    {% set conversion_rate = 1.60934 %}
