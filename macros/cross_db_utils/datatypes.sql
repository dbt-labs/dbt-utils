...
{%- macro redshift__type_string() -%} varchar {%- endmacro -%}

{% macro postgres__type_string() %} varchar {% endmacro %}
...
{% macro bigquery__type_numeric() %} numeric {% endmacro %}
...
{% macro bigquery__type_bigint() %} int64 {% endmacro %}
